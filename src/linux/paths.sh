...
ZED_EXTENSIONS_WORK_DIR="${XDG_DATA_HOME:-${HOME}/.local/share}/zed/extensions/work"
...
export ZED_CONFIG_DIR ZED_EXTENSIONS_DIR ZED_EXTENSIONS_WORK_DIR ZED_SETTINGS_FILE ZED_KEYMAP_FILE ZED_AGENTS_FILE
